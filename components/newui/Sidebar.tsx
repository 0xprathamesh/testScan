        ...
        <div className="flex flex-col items-center">
          <Link href="/newui">
            <div className=" text-white p-1 rounded-lg inline-block">
              <img
                src={`https://cdn.blocksscan.io/tokens/img/${logo}.png`}
                height={32}
                width={32}
                alt="logo"
              />
          ...
          <div
            className={`bg-gray-100 hover:bg-gray-200 cursor-pointer my-4 p-3 rounded-lg inline-block ${
              isActive("/newui/pulse") ? "text-blue" : ""
            }`}
            onClick={() => router.push("/newui/pulse")}
          >
            <BiPulse size={20} />
          </div>
          ...
          <div
            className="bg-gray-100 hover:bg-gray-200 cursor-pointer my-4 p-3 rounded-lg inline-block"
            onClick={() => router.push("/newui/explore")}
          >
          ...
          <div
            className="bg-gray-100 hover:bg-gray-200 cursor-pointer my-4 p-3 rounded-lg inline-block"
            onClick={() => router.push("/newui/txns")}
          >
            <FiSettings size={20} />
          </div>
          ...
          <div
            className="bg-gray-100 hover:bg-gray-200 cursor-pointer my-4 p-3 rounded-lg inline-block"
            onClick={() => router.push("/newui/blocks")}
          >
